...
import LP_search from "./page/LP_search.vue";
import SUHome from "./page/SuperUserHome.vue";
import SUVerify from "./page/SuperUserVerify.vue";
import SUSelect from "./page/SuperUserSelect.vue";
import Set from "./page/CommenReasonSet.vue";
// Vue.use(VueRouter);
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/lpsearch", component: LP_search },
    { path: "/superuserhome", component: SUHome },
    { path: "/superuserverify", component: SUVerify },
    { path: "/superuserselect", component: SUSelect },
    { path: "/commenreasonset", component: Set },
  ],
});
